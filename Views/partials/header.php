      ...
      <ul class="nav-menu">
        ...
        <?php if($_SESSION['user'] ?? false): ?>
            ...
            <form method="POST" action="/logout" class="">
                ...
                <li>
                    <button class="hover:text-gray-200 font-bold text-sm text-white uppercase no-underline hover:underline hover:bg-blue-700 px-4 py-3 rounded-md">Logout</button>
                </li>
            </form>
        <?php else: ?>
